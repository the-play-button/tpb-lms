...
- **Action corrective** : Implémenter pattern BASTION (check instructor first, puis student)
- **Phase cible** : Phase 3
...
- **Action corrective** : Implémenter pattern Intent+Guard (voir 1.12_appendix_TPB_BASTION.md)
- **Phase cible** : Phase 3
