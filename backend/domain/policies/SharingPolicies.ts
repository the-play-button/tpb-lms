 ...
 */
export const onlyOwnerCanSharePolicy = (contentRef: DraftContentRef | SharedContentRef, userEmail: Email): Result<string, 'allowed'> => {
 ...
 */
export const maxSharesPolicy = (existingShares: ActiveShare[], max: number = DEFAULT_MAX_SHARES): Result<string, 'allowed'> => {
