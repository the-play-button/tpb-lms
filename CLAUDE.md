...
- Storage : `tpb-cock/agent/intent_ledger/intent_ledger.db` (SQLite SSOT, FTS5).
- Sources : `tpb-cock/agent/intent_ledger/immutable_sources/{intent-compacts,research-snapshots,plans-references}/`.
